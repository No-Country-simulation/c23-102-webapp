				...
				<div className="absolute top-0 bg-black shadow-[0_0.1px_1px_rgba(255,255,255,0.4)] py-3 pt-6 base-top-styles base-top-styles-lg">
					<div className="flex justify-between items-center w-10/12 xl:w-[85%]">
						...
						<div className="flex flex-row items-center justify-center gap-8">
							<LinkWithIcon route={PLATFORM_ROUTES.RESTAURANT_PLATOS}>Crear</LinkWithIcon>
							<LinkWithIcon route={PLATFORM_ROUTES.RESTAURANT_MENUS}>Menus</LinkWithIcon>
							<LinkWithIcon route={PLATFORM_ROUTES.RESTAURANT_PEDIDOS}>Pedidos</LinkWithIcon>
							<LinkWithIcon route={PLATFORM_ROUTES.RESTAURANT_PROFILE}>Perfil</LinkWithIcon>
						</div>
